...
// // ---------------------------------------------------------------------------
// export type OccluderShape = { kind: "box"; width: number; height: number } | { kind: "polygon"; vertices: Vector[] };
...
//   /** Returns vertices in local space, centered on the actor origin */
